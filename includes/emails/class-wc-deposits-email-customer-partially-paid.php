...
if (!class_exists('WC_Deposits_Email_Customer_Partially_Paid')) :
    ...
    class WC_Deposits_Email_Customer_Partially_Paid extends WC_Email
    {
        ...
        private $still_needs_payment = false;
        /**
         * Constructor
         */
...
//            // Triggers for this email
        ...
        public function trigger($order_id, $order = false)
        {
            ...
            if (is_a($order, 'WC_Order')) {
                ...
                if($order->get_type() !== 'wcdp_payment' ||  $order->get_meta('_wc_deposits_payment_type', true)  === 'deposit'  ){
                    return;
                }
                ...
                $partial_payments = wcdp_get_order_partial_payments($parent->get_id());
                foreach($partial_payments as $single_payment){
                    if($single_payment->needs_payment()) $this->still_needs_payment = true;
                }

                //no need to send this email if this was the last payment, as the processing email will be sent
                if(!$this->still_needs_payment) return;
                ...
                $this->placeholders['{partial_payment_number}'] = $order->get_order_number();
        ...
        function get_content_html()
        {
            ...
            return wc_get_template_html($this->template_html, array(
                ...
                'payment_text' => $this->still_needs_payment ?  $this->get_payment_text() : '',
        ...
        {
            return __('Thank you for your payment', 'woocommerce-deposits');
        }

        public function get_default_email_text()
        {
            return __("Your payment {partial_payment_number} has been received. Your order details are shown below for your reference:", 'woocommerce-deposits');
