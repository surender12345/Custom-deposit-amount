...
class Envato_items_Update_Client{
	...
	function verify_purchase_code( $purchase_code ){
		...
		$args = array( 'timeout' => 60,  'body' => array( 'purchase_code' => $purchase_code , 'item_id' => $this->item_id ) );
	...
	protected function get_remote_response(){
		...
		$response = false;
		$args = array(  'timeout' => 60,  'body' => array( 'item_id' => $this->item_id , 'purchase_code' => $this->purchase_code , 'domain' => home_url() ) );
