...
class WC_Deposits_Admin_List_Table_Partial_Payments extends WC_Admin_List_Table {
    ...
    public function define_columns( $columns ) {
        ...
        $show_columns['order_number']     = __( 'Partial Payment', 'woocommerce-deposits' );
        ...
        $show_columns['wcdp_parent_order']       = __( 'Order', 'woocommerce' );
    ...
    protected function render_order_number_column() {
        ...
        if ( $this->object->get_status() === 'trash' ) {
            ...
            echo '<a href="' . esc_url( admin_url( 'post.php?post=' . absint( $this->object->get_id() ) ) . '&action=edit' ) . '" class="order-view "><strong>#' . esc_attr(  $parent->get_order_number() ) . ' ' . esc_html( $buyer ) . '</strong></a>';
        }
    }
