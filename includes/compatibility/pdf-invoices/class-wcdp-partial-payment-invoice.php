...
class WCDP_Partial_Payment_Invoice extends Order_Document_Methods {
    ...
    public function __construct( $order = 0 ) {
        ...
        $this->title	= __( 'Partial Payment Invoice', 'woocommerce-deposits' );
    ...
    public function get_title() {
        ...
        return apply_filters( "wpo_wcpdf_{$this->slug}_title", __( 'Partial Payment Invoice', 'woocommerce-deposits' ), $this );
    }
